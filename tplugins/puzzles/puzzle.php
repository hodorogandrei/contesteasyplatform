<html lang='en'>
        ...
        <script type="text/javascript">
            $(function() {
                $("#sortable").sortable({
                    ...
                    cursor: 'move',
                    update: function() {
                        var winningString = "nvwg,gklf,bfbv,dano,nrra,yqnn,pdfw,xkgx,huea,qazh,ivzp,sglt,dpcb,ptvg,zcrj,qjuj,elek,qosg,mjqs,itkk,dsdr,nrtf,nxwl,wqqh";
                        var currentString = '';
	...
	<div class="msg_text">Drag and Drop Images and Solve the Puzzle</div>
        <?php
            $image_names = "dsdr,xkgx,dano,dpcb,huea,ivzp,zcrj,sglt,wqqh,qosg,qazh,gklf,qjuj,nvwg,elek,nrra,pdfw,ptvg,itkk,mjqs,nrtf,nxwl,yqnn,bfbv";
