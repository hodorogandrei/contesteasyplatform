<?php
    ...
    if($_SESSION['logat'] == 'Da')
    {
        ...
        $sql = "SELECT * FROM `onipag` WHERE id=3"; 
        ...
        if(isset($_POST['submit']))
        {
            ...
            {
                $query="UPDATE `onipag` SET content='$content', title='$titlu' WHERE id=3";
                mysql_query($query);
            }
            else
                ...
                <div id="main">
                    ...
                    <div id="pagecontent">
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" id="validate">
                            ...
                            <br/>
                            <input name="submit" type="submit" value="Actualizare Regulament" class="no-warn"/>
                        </form>
                    </div>
