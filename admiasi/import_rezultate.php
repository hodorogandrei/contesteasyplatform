            ...
            if(!empty($_FILES['csvfile']['name']))
            {
                ...
                if(strcmp($ext,'csv')==0) 
                {
                    ...
                    for($i=0;$i<$size;$i++)
                    {
                        ...
                        */
                        $arr = explode(",", $line);
                        $sql = "INSERT INTO `rezultate` (`numele`,`clasa`, `judet`,`total`, `observatii`, `premiu`, `medalie`) VALUES ('".implode("','",$arr)."')";
                        //echo "$sql<br/>";
                        mysql_query($sql);
                        $numar++;
                    }
            ...
            <div id="contain">
                <div id="main">
                    ...
                    <div id="pagecontent">
                        ...
                        &Icirc;nt&acirc;mpina&#355;i probleme? <a href="import_rezultate_c.php">&Icirc;ncerca&#355;i uploader-ul clasic!</a><br/><br/>
                        <div id="file-uploader">
                            <noscript>
                                <form action="import_rezultate.php" method="post" enctype="multipart/form-data">
