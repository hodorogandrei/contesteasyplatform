...
$(document).ready(function() {
    ...
    $('a.delete-link').click(function (e) {
        ...
        var currdiv = $(this);
        confirm("Sunteti sigur(a) ca doriti sa stergeti acest abonat?", function () {
            $.ajax({
                url: 'newsletter.php?sterge='+del_id,
                dataType: 'json'
            });
    ...
    $('input.delete-link-more').click(function (e) {
        e.preventDefault();
        confirm("Sunteti sigur(a) ca doriti sa stergeti abonatii selectati?", function () {
            var data = { 'checkbox[]' : []};
            ...
            $.post("async-db/delete-newsletter.php", data, function(data){
                if(data=='gol')
