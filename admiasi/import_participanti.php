            ...
            <div id="contain">
                <div id="main">
                    ...
                    <div id="pagecontent">
                        ...
                        &Icirc;nt&acirc;mpina&#355;i probleme? <a href="import_participanti_c.php">&Icirc;ncerca&#355;i uploader-ul clasic!</a><br/><br/>
                        <div id="file-uploader">
                            <noscript>
                                <form action="import_participanti.php" method="post" enctype="multipart/form-data" id="form1">
            ...
            <script type="text/javascript">
                $(document).ready(function() {          
                    var uploader = new qq.FileUploader({
                        ...
                        action: 'server/import_participanti_ajax.php',
                        multiple: false,
                        maxConnections: 1,
                        debug: false,
                        sizeLimlit: 2048,
