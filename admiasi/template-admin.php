<?php
    ...
    if($_SESSION['logat'] == 'Da')
    {
        ...
        {
            $content = make_safe_lite($_POST['editor']);
            $titlu = make_safe_lite($_POST['titlu']);
            if(is_valid($_POST['titlu']))
            {
                $query="UPDATE `onipag` SET content='$content', title='$titlu' WHERE id=1";
                mysql_query($query);
                $mesaj = "Actualizare realizat&#259;!";
            }
            else
            ...
            <div id="contain">
                <div id="main">
                    ...
                    <div id="pagecontent">
                        ...
                        <br/><br/>
                        <b>Administrare pagina <i><?php echo $titlu;?></i>:</b><br/><br/>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" id="validate">
                            ...
                            <br/>
                            <input name="submit" type="submit" value="Actualizare <?php echo $titlu;?>" class="no-warn"/>
                        </form>
                    </div>
